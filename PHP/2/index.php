<?php include_once('config.php'); include('paginator.class.php'); include('Classes/PHPExcel.php'); ?>
<!doctype html>
<html lang="en-US" xmlns:fb="https://www.facebook.com/2008/fbml" xmlns:addthis="https://www.addthis.com/help/api-spec"  prefix="og: http://ogp.me/ns#" class="no-js">
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<title>Export an excel file with PHPExcel</title>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col">
				<a href="export.php?<?php echo $_SERVER['QUERY_STRING'];?>" class="btn btn-danger btn-sm float-right"><i class="fa fa-fw fa-file-excel"></i> Export Excel</a>
			</div>
		</div>
		<hr>
		<?php
